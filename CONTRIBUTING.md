...
Bug fixes for issues labeled `good first issue` or `help wanted` are the best starting point.

### New features

New features require prior discussion. Do not submit a feature MR without an existing open issue that has been discussed and approved for external contribution.
...
4. Only after maintainer approval: submit a merge request.

**Unsolicited feature MRs will be closed without review.** Our open issues are our internal roadmap. Just because an issue exists doesn't mean it's open for external contribution. Look for the `good first issue` or `help wanted` labels.
...
- No linked issue
- Unsolicited features without prior discussion
