...
const hardcodedConfig: AppConfig = {
  ...
  feedSettings: {
    ...
    feedIncludeGitPushes: true,
    feedIncludeGitPatches: true,
    feedIncludeGitPullRequests: true,
    feedIncludeGitPrUpdates: true,
    feedIncludeGitIssues: true,
    feedIncludeGitStatusReopened: true,
    feedIncludeGitStatusResolved: true,
    feedIncludeGitStatusClosed: true,
    feedIncludeGitStatusDraft: true,
