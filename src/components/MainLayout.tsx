    ...
    <>
      ...
      <div className={cn("flex justify-center mx-auto max-w-[1200px]", wrapperClassName)}>
        ...
        <Suspense fallback={<PageSkeleton />}>
          <div className={cn("relative flex-1 min-w-0 sidebar:border-l sidebar:border-r border-border bg-background/85 -mt-mobile-bar sidebar:mt-0", !noMaxWidth && "sidebar:max-w-[600px]", !noOverscroll && "pb-overscroll")}>
            <Outlet />
            {showFAB && (
