    ...
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h3 className="font-medium">App Relays</h3>
          </div>
          <div className="flex items-center gap-2">
        ...
        <p className="text-sm text-muted-foreground">
          Default relays provided by the app for reliable connectivity. These are used alongside your personal relays when enabled.
        </p>
        <div className={cn(
      ...
      <div className="space-y-3">
        <div className="flex items-center gap-2">
          ...
          <h3 className="font-medium">Your Relays</h3>
        </div>
        <p className="text-sm text-muted-foreground">
