...
export function NoteCard({ event, className, repostedBy, compact, threaded, threadedLast }: NoteCardProps) {
  ...
  const isTextNote = !isVine && !isPoll && !isGeocache && !isFoundLog && !isColor && !isFollowPack && !isArticle && !isMagicDeck && !isStream && !isFileMetadata && !isTheme && !isVoiceMessage && !isPhoto && !isVideo;
