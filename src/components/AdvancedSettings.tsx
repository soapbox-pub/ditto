...
import { ChevronDown, ChevronUp, Bug, RotateCcw, AlertTriangle, Coins, Eye, EyeOff } from 'lucide-react';
...
function CurrencySettingsSection() {
  ...
  return (
    <SettingsSection title="Currency" icon={<Coins className="h-4 w-4" />} open={open} onOpenChange={setOpen}>
      <div className="px-3 pt-3 pb-4 space-y-3">
        <div>
          ...
          <RadioGroup value={currencyDisplay} onValueChange={handleCurrencyChange} className="gap-2">
            <label
