            ...
            <PopoverContent side="top" align="start" sideOffset={8} className="w-[260px] p-0 rounded-2xl shadow-xl border border-border overflow-hidden">
              ...
              <div className="border-b border-border py-2">
                <SidebarThemeDropdown
                  ...
                  onNavigate={() => setAccountPopoverOpen(false)}
                  className="flex items-center justify-between w-full px-4 py-2.5 text-sm font-medium hover:bg-secondary/60 transition-colors"
                />
              </div>
