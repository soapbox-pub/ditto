      ...
      <PageHeader
        ...
        titleContent={
          <div className="flex-1 min-w-0">
            <h1 className="text-xl font-bold flex items-center gap-1.5"><FormattedMessage id="settings.wallet.title" defaultMessage={"Wallet"} /> <HelpTip faqId="connect-wallet" /></h1>
            <p className="text-sm text-muted-foreground mt-0.5">
              <FormattedMessage id="settings.wallet.subtitle" defaultMessage={"Manage wallet connections and payments"} />
            </p>
          </div>
        }
      />
