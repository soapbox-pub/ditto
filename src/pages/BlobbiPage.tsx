...
function BlobbiContent() {
  ...
  // Externally-created Blobbis (e.g. Blobbi Island) are part of this
  // collection: since @blobbi-kit/core 0.5.1, legacy detection is purely
  // schema-based, so an event branded `client`/`t == "blobbi"` is no longer
  // misclassified as an old-app event, and no host-side recovery is needed.
  const {
    companions,
  ...
  // created directly by Blobbi Island, which the collection now includes).
