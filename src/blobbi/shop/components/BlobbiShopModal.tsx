...
import { ShoppingBag, Package, Utensils, Gamepad2, Heart, Droplets, Palette, X } from 'lucide-react';
...
import { BlobbiInventoryContent } from './BlobbiInventoryModal';
...
interface BlobbiShopModalProps {
  ...
  /** Initial tab to open on ("shop" or "inventory"). Defaults to "shop". */
  initialTab?: TopTab;
        ...
        <DialogContent className="max-w-2xl w-[calc(100%-2rem)] max-h-[85vh] flex flex-col p-0 gap-0 [&>button:last-child]:hidden">
          ...
          <div className="sticky top-[60px] sm:top-[72px] z-10 bg-background px-4 sm:px-6 pt-3 sm:pt-4 pb-2 border-b">
            <div className="flex gap-1.5 sm:gap-2 overflow-x-auto pb-1 -mx-1 px-1">
              ...
              {/* Shop category sub-tabs (only when Shop tab is active) */}
              {topTab === 'shop' && (
                <>
