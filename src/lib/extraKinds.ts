...
export const EXTRA_KINDS: ExtraKindDef[] = [
  ...
  },
  {
    ...
    id: 'lists',
    showKey: 'showLists',
    feedKey: 'feedIncludeLists',
    label: 'Lists',
    description: 'Named groups of people with their own feed',
    route: 'lists',
    addressable: true,
    section: 'social',
    blurb: 'Create named groups of people and view a combined feed of their posts. Use Listr for full list management.',
    sites: [{ url: 'https://list.lol', name: 'Listr' }],
  },
  {
    kind: 39089,
    id: 'packs',
