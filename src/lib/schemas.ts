...
export const FeedSettingsSchema = z.looseObject({
  ...
  showQuizzes: z.boolean().optional(),
  showQuizDefinitions: z.boolean().optional(),
  showQuizResults: z.boolean().optional(),
  feedIncludeQuizzes: z.boolean().optional(),
  feedIncludeQuizResults: z.boolean().optional(),
  ...
  feedIncludeMemoryCards: z.boolean().optional(),
  ...
  feedIncludeGitRepos: z.boolean().optional(),
  feedIncludeGitPushes: z.boolean().optional(),
  feedIncludeGitPatches: z.boolean().optional(),
  feedIncludeGitPullRequests: z.boolean().optional(),
  feedIncludeGitPrUpdates: z.boolean().optional(),
  feedIncludeGitIssues: z.boolean().optional(),
  feedIncludeGitStatusReopened: z.boolean().optional(),
  feedIncludeGitStatusResolved: z.boolean().optional(),
  feedIncludeGitStatusClosed: z.boolean().optional(),
  feedIncludeGitStatusDraft: z.boolean().optional(),
...
export const AppConfigSchema = z.object({
  ...
  widgetMarketplaceEnabled: z.boolean().optional(),
